...
// Purpose: Delete index templates per kibana space
//
// Node requirements:
...
//
// Run script
//     $ node delete_index_templates.js <org-space-filename> <environment>
//       environment:
...
if (process.env.ELASTIC_ENV_PATH == null) {
	...
	console.log("1. at the command prompt type: ELASTIC_ENV_PATH=<path to .env file> node delete_index_templates.js <org-space-filename> <environment>")
	...
	console.log("In the 2 scenario, at the command prompt, just do:  node delete_index_templates.js <org-space-filename> <environment> ")
    process.exit(1)
}

if (process.argv.length != 4) {
	console.log("usage: node delete_index_templates.js <org-space-filename> <environment>")
    process.exit(2)
}
...
for (var i = 1; i < rows.length; i++) {
	...
	delete_metrics_index_template(rows[i])
}

function delete_metrics_index_template(row) {
