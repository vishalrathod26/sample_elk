...
//
// Run script
//     $ node delete_index.js <index-list-filename> <org-space-fiename> <environment>
//       environment:
...
if (process.env.ELASTIC_ENV_PATH == null) {
	...
	console.log("1. at the command prompt type: ELASTIC_ENV_PATH=<path to .env file> node delete_index.js <index-list-filename> <org-space-filename> <environment>")
	...
	console.log("In the 2 scenario, at the command prompt, just do:  node delete_index.js <index-list-filename> <org-space-filename> <environment> ")
    process.exit(1)
}

if (process.argv.length != 5) {
	console.log("usage: node delete_index.js <index-list-filename> <org-space-filename> <environment>")
    process.exit(1)
}
